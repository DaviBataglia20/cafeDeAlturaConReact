    ...
    <div className="px-12 py-10 bg-MejorCafe">
        <div className="flex justify-between items-center gap-6 ">
            ...
            <div className="flex gap-4">
                <Link to="/Shop"><Button estilo={"cursor-pointer font-semibold text-sm leading-4 text-white rounded py-3 px-6 shadow-botones	 border-0 bg-gray-900"} text={"Descubrir orígenes"} />
</Link>
                <Link to="/Shop"><Button estilo={"cursor-pointer font-semibold text-sm leading-4 text-white rounded py-3 px-6 shadow-botones	 border-0 bg-green-800 "} text={"Comprar café"} /></Link>
