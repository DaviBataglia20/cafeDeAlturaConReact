    ...
    <div className="px-12 py-10 bg-MejorCafe">
        <div className="flex justify-start items-center gap-6">
            ...
            <div className="flex gap-4">
                <Button estilo={"cursor-pointer font-semibold text-sm leading-4 text-white rounded py-3 px-6  shadow-2xl border-0 bg-gray-900"} text={"Descubrir orígenes"} />
                <Button estilo={"cursor-pointer font-semibold text-sm leading-4 text-white rounded py-3 px-6   shadow-2xl border-0 bg-green-800"} text={"Comprar café"} />
            </div>
            </div>
            <FotoMejorCafe/>
        </div>
